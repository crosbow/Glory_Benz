...
function page({}) {
  ...
  return (
    <div className="relative mx-auto  max-w-[1550px] w-[94%] px-4 md:px-0 lg:px-8 xl:px-0 mt-8">
      <div>
      ...
      <div className=" mt-5 md:mt-10 flex ">
        <FilterBar />
        <div className="relative box-border mx-auto  max-w-[1550px] w-[94%] px-4 md:px-0 lg:px-8 xl:px-0 ml-2">
